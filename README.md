...
| 2026-06-09 | 新增 **Agnes 创意空间**（https://ailabing.cn/tools/agnes-creative-space/）为**方式二**，支持在线生成（文生图/图生图/文生视频/图生视频）和对话模式自助排查问题；Skill 改为**方式一（⭐ 推荐）**，新增 Agnes Help Skill **教程信息图**和完整**使用说明** |
